...
export function NewSchools() {
  const newSchoolsHook = useNewSchools();
  const { newSchoolsStats } = newSchoolsHook;

  if (!hasData(newSchoolsStats)) return null;
