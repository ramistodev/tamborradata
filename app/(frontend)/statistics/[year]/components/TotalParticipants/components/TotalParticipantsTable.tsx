...
export function TotalParticipantsTable({ stats }: ReturnType<typeof useTotalParticipants>) {
  return (
    <>
      <table className="w-full sm:w-[400px] md:w-[450px] xl:w-[650px] border border-(--color-border)">
        <thead>
          <tr>
            <th className="w-18 text-sm border-b border-(--color-border) text-center p-2">Año</th>
