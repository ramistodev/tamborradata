...
export function CommonNamesBySchool() {
  const commonNamesBySchoolHook = useCommonNamesBySchool();
  const { commonNamesStats } = commonNamesBySchoolHook;

  if (!hasData(commonNamesStats)) return null;
