      ...
      <div className="flex flex-col gap-2">
        {participants &&
          participants.map((participant, index) => (
            <div
              key={index}
              className="grid grid-cols-[3fr_4fr_1fr] items-center gap-4 px-4 py-3 bg-(--color-bg-secondary) rounded-lg border border-(--color-border) hover:border-(--eye-catching-text) transition-colors"
            >
